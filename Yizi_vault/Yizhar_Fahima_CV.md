...
**Quantum Key Distribution via Optical Communication** | _Final Project_ | [Link to Project](https://github.com/yizharf9/qkd/tree/simulation)
...
- Co-authored an academic article detailing project findings with a partner, under the guidance of [Prof. Shlomo Greenberg](https://scholar.google.com/citations?user=ndvw4oEAAAAJ&hl=en) , which is currently undergoing the publication process. 
	

**Generative Models in 3D Artificial Intelligence** | _Academic Project & Paper_ | [link for project content](https://github.com/yizharf9/coding/tree/master/bgu/gen_models/orthogonal_diff)
...
**Digital Signal Processing (DSP) Applications** | _Academic Lab_ | [link for DSP lab content](https://github.com/yizharf9/coding/tree/master/bgu/dsp_lab)
...
- **Environments & Tools:** Powershell, Linux (Ubuntu), Git-Bash, GitHub, VirtualBox, LaTeX/Markdown
    
- **Languages:** Hebrew (Native), English (Native-level fluency), French (Basic)
...
- **Relevant Coursework:** Generative Models in AI (95); Introduction to Signal Processing (90); Introduction to Machine Learning (83); Introduction to Computer Networks (83); Digital Signal Processing (DSP) Lab (94)
...
**Basic Training Squad Commander ("Rovai 02/03")** | Israel Defense Forces (IDF) | _2017 – 2020_ Commanded and trained squads of recruits during basic training cycles.
